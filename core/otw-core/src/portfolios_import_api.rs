...
use crate::portfolios_import::{self, Mapping};
...
pub fn routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/api/portfolios/import/batches/{id}/revert", post(revert_batch))
        .route("/api/portfolios/import/batches/{id}", axum::routing::delete(forget_batch))
}
