...
pub const CATALOG: &[Endpoint] = &[
    ...
    // ── backtest ─────────────────────────────────────────────────────────────
    Endpoint { module: "backtest", method: "POST", path: "/api/backtest/run", desc: "Run a backtest (strategy config + dataset) and return metrics/equity curve." },
    Endpoint { module: "backtest", method: "GET", path: "/api/backtest/runs", desc: "List saved runs." },
    Endpoint { module: "backtest", method: "POST", path: "/api/backtest/runs", desc: "Save a run." },
