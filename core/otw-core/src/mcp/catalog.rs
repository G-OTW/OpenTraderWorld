...
pub const CATALOG: &[Endpoint] = &[
    ...
    Endpoint { module: "journal", method: "GET", path: "/api/journal/calendar", desc: "Daily realized-PnL buckets for the month-grid heatmap. Same filters as breakdown." },
    ...
    Endpoint { module: "backtest", method: "POST", path: "/api/backtest/strategies", desc: "Create a strategy. Body: name, description, settings (engine Settings JSON; validated). Returns id." },
    ...
    Endpoint { module: "backtest", method: "PUT", path: "/api/backtest/strategies/{id}", desc: "Update a strategy. Body: name, description, settings (validated)." },
    Endpoint { module: "backtest", method: "DELETE", path: "/api/backtest/strategies/{id}", desc: "Delete a strategy." },
    ...
    Endpoint { module: "backtest", method: "POST", path: "/api/backtest/indicators", desc: "Create a custom indicator. Body: name, description, definition (node-graph DAG JSON; validated: bounded, no forward/self refs). Returns id." },
    Endpoint { module: "backtest", method: "GET", path: "/api/backtest/indicators/{id}", desc: "Get one custom-indicator definition." },
    Endpoint { module: "backtest", method: "PUT", path: "/api/backtest/indicators/{id}", desc: "Update a custom indicator. Body: name, description, definition (validated)." },
    Endpoint { module: "backtest", method: "DELETE", path: "/api/backtest/indicators/{id}", desc: "Delete a custom indicator." },
    // ── quant ────────────────────────────────────────────────────────────────
