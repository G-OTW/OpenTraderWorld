...
> Project website: **[opentraderworld.com](https://opentraderworld.com)**: module tour,
> [live demo](https://demo.opentraderworld.com), [community guides](https://opentraderworld.com/docs)
> and [roadmap voting](https://opentraderworld.com/suggestions).
...
- **No subscription.** The core tools cost nothing to run. Some modules can optionally use external data providers (many with free tiers), and you bring your own API keys.
...
Modules are feature bundles you install or detach from **Settings → Modules**. Everything ships with the app, and installing a module just switches it on. Highlights:

- **[Trading Journal](/modules/journal)**: log trades with templates, fee schedules, multi-currency PnL and full performance stats.
- **[Market data & backtesting](/modules/market-data)**: download OHLCV history from multiple providers, chart any instrument live or on demand with indicators, backtest rule-based strategies, and run quant risk analytics.
...
Not ready to install? Try the [live demo](https://demo.opentraderworld.com), a shared instance
seeded with data, reset every 15 minutes. [What demo mode is](/guide/demo), and what it blocks.
