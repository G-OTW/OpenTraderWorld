...
The shared list of **notification channels**: where the app is allowed to push, created once and reused by every module that notifies (RemindMe, Watchlist price alerts, Mailbox, Webhooks).
