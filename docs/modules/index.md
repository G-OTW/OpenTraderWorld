...
Historical Data, Visualization and Watchlists also share one list of **[data connectors](/config/connectors)**: a provider account is created once and granted to the modules that may use it.
...
| [Historical Data Visualization](/modules/market-data#histviz) | Candle/OHLC/line/Renko charts with indicators, live or on demand, on any instrument a connector serves. |
