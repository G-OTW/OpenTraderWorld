...
The [dashboard, search and notifications](/modules/dashboard) sit above all of them and are always there.

## Dependencies

Some modules build on **Historical Data**'s dataset catalogue and need it installed:
...
Historical Data, Visualization, Watchlists and the Trading Journal also share one list of **[data connectors](/config/connectors)**: a provider account is created once and granted to the modules that may use it.
...
| [Historical Data Visualization](/modules/market-data#histviz) | A workspace of candle/OHLC/line/Renko charts with indicators, drawings, comparisons and server-watched alerts, live or on demand, on any instrument a connector serves. |
...
| Module | What it does |
|---|---|
| [Watchlists](/modules/portfolio#watchlists) | Symbol watchlists with live prices, day changes, sparklines and notes. |
| [Portfolio Tracker](/modules/portfolio#portfolios) | Live value, cash and income ledger, performance against the risk taken, allocation drift and stress testing. |
| [MyWealth](/modules/portfolio#wealth) | Net worth across everything you own and owe, with portfolios read live rather than copied. |
...
| [Mailbox](/modules/news-research#mailbox) | Newsletters, market news and broker mail read from your own IMAP mailbox, tracker-free. |
...
| [Webhooks](/modules/productivity#webhooks) | Private inbound URLs that turn external alerts into notifications. |
| [Automator](/modules/automator) | Workflows over your own API and the outside world, by hand or on a schedule. |

### AI

| Module | What it does |
|---|---|
| [Agent](/modules/agent) | Built-in AI chat assistant (bring your own provider) that can also act on your data via MCP, with memory, skills and external MCP servers. |
