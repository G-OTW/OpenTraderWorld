...
A public sandbox runs at **[demo.opentraderworld.com](https://demo.opentraderworld.com)** (linked
from the [website](https://opentraderworld.com)) — no
...
- 🧩 **Modular.** 25+ modules — install only what you use, detach the rest.
...
**TraderSync** offers automatic broker imports and reporting as a cloud SaaS. If you'd rather not have your trading history on a third-party server (or pay a monthly fee), OpenTraderWorld gives you a self-hosted alternative — import your broker statement or spreadsheet (columns, delimiter, decimal and date conventions detected, each import a revertible, de-duplicated batch), for both the journal and portfolio ledgers.
...
As a final word: OpenTraderWorld is free, ships with 25+ modules, and has an ambitious roadmap.
...
| [Historical Data Visualization](https://g-otw.github.io/OpenTraderWorld/modules/market-data#histviz) | Candle/OHLC/line/Renko charts with indicators, live or on demand, on any instrument a connector serves. |
...
| Module | What it does |
|---|---|
| [Agent](https://g-otw.github.io/OpenTraderWorld/modules/agent) | Built-in AI chat assistant (bring your own provider, switch model or prompt mid-conversation) that can also act on your data via MCP, with memory, skills and external MCP servers — reachable from a floating chat on every page. |
...
- **Write for the community** — guides written in the app's Editor can be submitted for
  publication in the shared [Community Docs](https://opentraderworld.com/docs) library,
  readable by every install.
...
| [opentraderworld.com/suggestions](https://opentraderworld.com/suggestions) | Suggestions & polls — propose features, vote on the roadmap. |
