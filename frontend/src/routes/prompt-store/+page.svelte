...
<style>
  ...
  /* Filter tags as a continuous hairline band, no floating rounded pills.
     The band sits on the page ground and each pill draws its own filet, so the
     empty stretch after the last tag stays page-coloured. */
  .tag-rail {
    display: flex;
    gap: 0;
    overflow-x: auto;
  ...
  /* Detached cards: each one a surface tile on the page ground, spaced by a real
     gutter so the grid reads as cards and not as one flat sheet. */
  .grid {
    display: grid;
