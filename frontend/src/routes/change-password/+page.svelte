<script>
  ...
  async function submit() {
    error = '';
    // Length and the breach screen are the server's call: one policy, in one place, with a
    // message that says exactly what to fix. Only the confirm-field mismatch is decided here.
