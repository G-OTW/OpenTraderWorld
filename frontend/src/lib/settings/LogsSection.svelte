...
<div class="section">
  <div class="head">
    ...
    <div class="capture">
      ...
      <Dropdown
        value={captureLevel}
        onpick={changeCapture}
        ariaLabel={$t('settings.logs.captureLevel')}
  ...
  <div class="toolbar">
    <div class="lvl">
      <Dropdown
        ...
        onpick={reload}
        ariaLabel={$t('settings.logs.allLevels')}
        options={[
          { value: '', label: $t('settings.logs.allLevels') },
          ...LEVELS.map((l) => ({ value: l, label: $t('settings.logs.andWorse', { level: l }) }))
        ]}
      />
    </div>
    <input
