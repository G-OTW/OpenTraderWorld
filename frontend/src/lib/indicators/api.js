 ...
 * indicator saved from the backtest page is the same row the chart module draws, and an edit
 * on either side shows up on the other. Nothing here is backtest-specific.
 */
