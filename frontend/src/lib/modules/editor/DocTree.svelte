...
<div class="doctree">
  <div class="tree-head">
    ...
    <span class="head-actions">
      <button class="act" title={$t('editor.docTree.expandAll')} onclick={expandAll}><Icon name="plus" size={13} /></button>
      <button class="act" title={$t('editor.docTree.collapseAll')} onclick={collapseAll}><Icon name="minus" size={13} /></button>
