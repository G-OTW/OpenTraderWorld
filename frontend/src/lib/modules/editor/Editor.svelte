<script>
  ...
  const TEXT_COLORS = ['#e5484d', '#f5a623', '#30a46c', '#0091ff', '#8e4ec6', '#e93d82'];
  const HIGHLIGHTS = ['#fff3a3', '#b7f0c1', '#bfe3ff', '#ffd1dc', '#e6d4ff', '#ffe0b3'];
...
<style>
  ...
  /* A highlighter pen, not a themed surface: the pair is fixed together (15.4:1)
     and reads the same on either ground, the way a marker does on paper. */
