<script>
  ...
  function build(r, p) {
    ...
    return {
      ...
      title: [
        { text: $t('quant.mc.finalEquityDist'), left: 56, top: 4, textStyle: { fontSize: 12, color: p.muted } },
        { text: $t('quant.mc.maxDrawdownDist'), left: '58%', top: 4, textStyle: { fontSize: 12, color: p.muted } }
      ],
      tooltip: {
        trigger: 'axis',
      ...
      xAxis: [
        { type: 'value', gridIndex: 0, scale: true, axisLine: { lineStyle: { color: p.border } }, axisLabel: { color: p.muted } },
        { type: 'value', gridIndex: 1, axisLabel: { color: p.muted, formatter: '{value}%' }, axisLine: { lineStyle: { color: p.border } } }
      ],
      yAxis: [
        { type: 'value', gridIndex: 0, axisLabel: { color: p.muted }, splitLine: { lineStyle: { color: p.border, opacity: 0.3 } } },
        { type: 'value', gridIndex: 1, axisLabel: { color: p.muted }, splitLine: { lineStyle: { color: p.border, opacity: 0.3 } } }
      ],
      series: [
        {
          type: 'bar',
