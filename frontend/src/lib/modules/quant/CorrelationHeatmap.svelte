<script>
  ...
  function build(c, p) {
    ...
    return {
      ...
      xAxis: { type: 'category', data: c.labels, axisLine: { lineStyle: { color: p.border } }, axisTick: { show: false }, axisLabel: { color: p.dim, fontFamily: p.mono, fontSize: 10, rotate: 30 }, splitArea: { show: true } },
      yAxis: { type: 'category', data: c.labels, axisLine: { lineStyle: { color: p.border } }, axisTick: { show: false }, axisLabel: { color: p.dim, fontFamily: p.mono, fontSize: 10 }, splitArea: { show: true } },
      visualMap: {
        min: -1,
        max: 1,
        calculable: true,
