<script>
  ...
  // (slate, sage, tan, brick, mauve-grey, olive-grey). Same count/positions.
  const PALETTE = ['', '#7d8a99', '#7fb894', '#bfa06f', '#c9776b', '#9a95a3', '#93a389'];
...
<style>
  ...
  .checkrow.remind {
    ...
    border: 0.5px solid color-mix(in srgb, var(--amber) 30%, var(--border));
    border-radius: 0;
  }
