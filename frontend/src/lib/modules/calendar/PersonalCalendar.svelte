...
<style>
  ...
  /* Segmented prev / today / next group — continuous filet bar. */
  .seg {
    display: inline-flex;
  ...
  /* Zoom view picker: a continuous segmented filet bar. */
  .views {
    display: inline-flex;
    background: transparent;
    border: 0.5px solid var(--border-control);
  ...
  .fc-host:global(.fc) {
    ...
    /* Sits on a solid --accent fill: white is 2.9:1 on the dark theme's lavender. */
  ...
  /* The pill is a 14% accent *tint*, not solid accent — white on it measures 1.2:1 in
     the light theme (the number vanished). The accent itself clears 4.5:1 on its own
     tint in both themes, and keeps "today" reading as special. */
  ...
  /* Events: flat filet chips, no radius/shadow. */
