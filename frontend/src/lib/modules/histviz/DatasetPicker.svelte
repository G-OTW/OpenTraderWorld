...
<style>
  ...
  /* Mixing toward #fff lightens correctly on the light theme's deep indigo, but on
     dark the accent is already a pale lavender — it washed out. --accent-hover is
     the per-theme step. */
  .download:hover {
