        ...
        <div class="body">
          ...
          {:else}
            ...
            <div class="grid">
              ...
              <div class="fld">{$t('backtest.grid.direction')}
                <Dropdown
      ...
      {#if open.sizing}
        <div class="body">
          ...
          {:else if settings.sizing.mode === 'fixed_qty'}
            ...
            {#if (settings.leverage ?? 1) > 1}
              <p class="note">{$t('backtest.settings.qtyLeverageNote')}</p>
            {/if}
      ...
      {#if open.costs}
        <div class="body">
          <div class="grid">
            ...
            <div class="fld">{$t('backtest.settings.kind')}
              <Dropdown
            ...
            <div class="fld">{$t('backtest.settings.per')}
              <Dropdown
      ...
      {#if open.advanced}
        <div class="body">
          ...
          <div class="grid">
            ...
            <div class="fld">{$t('backtest.adv.afterAddSl')}
              <Dropdown
          ...
          <div class="grid">
            <div class="fld">{$t('backtest.adv.slipKind')}
              <Dropdown
