...
<style>
  ...
  .step.out { border-color: color-mix(in srgb, var(--accent) 55%, var(--border)); }
  ...
  .out-toggle:hover { color: var(--accent); }
  ...
  .add:hover { border-color: color-mix(in srgb, var(--accent) 50%, var(--border)); }
