...
<style>
  ...
  /* White, not --accent-contrast: that token is tuned against --accent (near-black
     on the dark theme) and would vanish on this green fill. Both themes' --green
     are dark enough to carry white text. */
  .toggle.on {
    color: #fff;
