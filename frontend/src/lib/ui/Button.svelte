<script>
  ...
  //
  // `primary` is the single promoted action in a local context; the quiet outline
  // variants carry supporting actions. `danger` stays red text + a muted red filet.
  // See the shared .btn layer in theme/components.css.
