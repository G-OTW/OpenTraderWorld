<script>
  ...
  //
  // No variant wears an accent fill or outline: institutional restyle spends the
  // accent only on nav/status/focus/equity. `primary` reads as the action through
  // --fw-medium alone (one per screen); `danger` through red text + a muted red
  // filet. See the .btn layer in theme/components.css.
